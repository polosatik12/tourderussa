...
const hotels = [
{
  name: 'Igora Resort & Spa',
  address: 'пос. Сосново, Приозерский р-н',
  description: 'Современный курортный комплекс с бассейном, спа-центром, рестораном. Горнолыжная инфраструктура.',
  details: 'Премиальный горнолыжный и спа-курорт на берегу озера. Крытый аквапарк, несколько ресторанов, конференц-залы. Идеальное расположение для участников мероприятия.',
  amenities: ['Wi-Fi', 'Бассейн', 'SPA', 'Ресторан'],
  bookingUrl: 'https://igora.ru',
  image: '/images/igora-hero.jpg'
},
{
  name: 'Загородный клуб «Лесная Рапсодия»',
  address: 'пос. Коробицыно, Выборгский р-н',
  description: 'Уютный загородный отель в окружении хвойного леса. Wi-Fi, парковка, ресторан с террасой.',
  details: 'Комфортный загородный клуб с атмосферой скандинавского шале. Финская сауна, открытая терраса, ресторан с авторской кухней. Тихое расположение в 15 минутах от трассы.',
  amenities: ['Wi-Fi', 'Парковка', 'Сауна', 'Ресторан'],
  bookingUrl: 'https://lesnaya-rapsodiya.ru',
  image: '/images/hero-5.jpg'
},
{
  name: 'Отель «Приозерский»',
  address: 'г. Приозерск, ул. Калинина, 12',
  description: 'Городской отель в центре Приозерска. Удобная транспортная доступность, кафе, парковка.',
  details: 'Современный отель в историческом центре Приозерска. Рядом крепость Корела и набережная Вуоксы. Кафе с домашней кухней, бесплатная парковка.',
  amenities: ['Wi-Fi', 'Парковка', 'Кафе', 'Кондиционер'],
  bookingUrl: 'https://priozersk-hotel.ru',
  image: '/images/hero-6.jpg'
}];

const routes = [
{ name: 'Intro Tour', distance: '32 км', elevation: '~500 м', desc: 'Кольцевая дистанция для начинающих имеет протяженность 36 километров с набором высоты 500 метров, что красноречиво говорит об рельефе местности. Преодолев 1 полный круг, на ключевом перекрестке, соответствующему 29-ти км от старта, следует двигаться прямо по указателю на финиш. Оставшиеся 2 с половиной километра до финиша идут с небольшим уклоном в гору.', mapEmbed: 'https://ridewithgps.com/embeds?type=route&id=54067216&metricUnits=true&sampleGraph=true' },
{ name: 'Median Tour', distance: '60 км', elevation: '~850 м', desc: 'Средняя дистанция потребует еще больше сил и опыта от участников Tour de Russie. MEDIAN Tour составляет 2 круга по 30 километров каждый с набором высоты 850 метров, за всю дистанцию. После первых 30-ти километров, на ключевом перекрестке следует повернуть на лево, по указателю 60/86 км. После прохождения второго круга, в этом месте, необходимо двигаться прямо в сторону финиша. Финальные километры дистанции местами имеют градиент до 10 %.', mapEmbed: 'https://ridewithgps.com/embeds?type=route&id=54067308&metricUnits=true&sampleGraph=true' },
{ name: 'Grand Tour', distance: '86 км', elevation: '~1200 м', desc: 'Полная дистанция GRAND Tour в «Игоре» имеет протяженность 86 километров с набором высоты 1200 метров, рассчитана на хорошо подготовленных спортсменов. Это максимальный набор из всех заездов сезона. После прохождения трех кругов на перекрестке с отметкой компьютера 83 километров от старта, следует двигаемся прямо в сторону финиша. На дистанции 86 км присутствует лимит времени.\n\nПосле двух кругов, участников, которые не впишутся по времени, контролеры будут направлять в сторону финиша. Место и результат в итоговом протоколе будет присуждаться с пометкой минус 1 круг.', mapEmbed: 'https://ridewithgps.com/embeds?type=route&id=54067326&metricUnits=true&sampleGraph=true&hideSurface=true' }];
