            ...
            <div className="flex-1">
              ...
              <motion.div
                  ...
                  <p className="text-base md:text-lg leading-relaxed text-foreground whitespace-pre-line">
                    {'Tour de\u00A0Russie\u00A0— это новая глава в\u00A0российском велоспорте для\u00A0любителей, серия велозаездов в\u00A0самых исторически значимых местах нашей страны.'}
                  </p>
              ...
              <motion.div
                ...
                <p className="text-base md:text-lg leading-relaxed text-foreground">
                  Все заявленные мероприятия включены в&nbsp;официальные календарные планы физкультурных и&nbsp;спортивных мероприятий Санкт-Петербурга, Владимирской области (Суздаль), Ленинградской области и&nbsp;Москвы.
                </p>
                ...
                <p className="text-base md:text-lg leading-relaxed text-foreground">
                  ...
                  <Link to="/corporate" className="text-primary font-semibold hover:underline font-serif">Корпоративная лига</Link>
