    ...
    <header className={`tdr-header ${isScrolled ? 'shadow-lg' : ''}`}>
      <div className="tdr-header-main tdr-header-main--full">
        ...
        <div className="hidden md:flex items-center justify-center">
          <div className="tdr-header-grid">
            ...
            <Link to="/corporate" className={`tdr-nav-link tdr-grid-bot-9 font-mono ${isActive('/corporate') ? 'active' : ''}`}>Корпоративная лига</Link>
      ...
      <div className="md:hidden bg-primary border-t border-white/10 py-5 px-6 overflow-y-auto max-h-[calc(100vh-88px)]">
          <nav className="flex flex-col gap-1">
            {/* Primary links — same order as desktop bottom row */}
            <a
            href="#about-section"
            ...
            <Link to="/calendar" className="text-white font-bold text-sm uppercase tracking-wider py-3 min-h-[44px] flex items-center" onClick={() => setIsMobileMenuOpen(false)}>Календарь</Link>
            <Link to="/news" className="text-white font-bold text-sm uppercase tracking-wider py-3 min-h-[44px] flex items-center" onClick={() => setIsMobileMenuOpen(false)}>Новости</Link>
            ...
            <div className="border-t border-white/10 mt-3 pt-3 flex flex-col gap-1">
              ...
              <Link to="/partners" className="text-white/80 font-medium text-sm py-3 min-h-[44px] flex items-center" onClick={() => setIsMobileMenuOpen(false)}>Партнеры</Link>
