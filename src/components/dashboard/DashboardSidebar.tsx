...
import { faUser, faCalendarDays, faFileLines, faHeart, faCreditCard, faHouse, faCartShopping, faRightFromBracket, faXmark, faShieldHalved } from '@fortawesome/free-solid-svg-icons';
...
const menuItems: { path: string; icon: IconDefinition; label: string }[] = [
